...
describe("Ejercicios filter", function () {
  describe("Ejercicio 4 - Crea un segundo array result4 a partir del array numbers2 que devuelva solo los impares", function () {
  ...
  describe("Ejercicio 5 - Dado el array foodList2, genera un segundo array result5 que filtre los platos veganos y saque una sentencia como la del ejemplo", function () {
  ...
  describe("Ejercicio 6 - Dado el array inventory, devolver un array result 6 con los nombres de los elementos que valgan más de 300 euros", function () {
    ...
    it("El array result6 devuelve el valor correcto", function () {
      ...
      expect(result6).toEqual(["TV Samsung", "Viaje a Cancún"]);
    });
  });
});
...
it("La variable result9 devuelve el resultado correcto", function () {
  expect(result8).toEqual(
    `Me llamo ${sentenceElements[2]} y quiero sentir la fuerza con javascript`
  );
});
